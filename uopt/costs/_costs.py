...
from uopt._types import ArrayLike
from uopt.base.cost import BaseCost
from uopt.costs._utils import register_cost
...
class LeafDistance(BaseCost):
    ...
    def __init__(
            self, adata: AnnData, weight: Union[str, Callable[[Any, Any, Dict[Any, Any]], float]] = "weight",
            **kwargs: Any
    ):
