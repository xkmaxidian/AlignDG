...
from uopt._types import ProblemStage_t
...
if TYPE_CHECKING:
    from uopt.base.problems.compound_problem import BaseCompoundProblem
...
class ProblemManager(Generic[K, B]):
    ...
    def add_problem(
        ...
        """
        from uopt.base.problems.compound_problem import CompoundProblem
