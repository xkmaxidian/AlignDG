...
def create_spot_pairs(input_adata, input_iter_comb, use_rep='latent', alpha=0.1, tau_a=1, tau_b=1, epsilon=1e-3):
    ...
    for comb in input_iter_comb:
        ...
        ''' for simplicity, we temporarily use the code provided in Moscot to implement optimal transport '''
